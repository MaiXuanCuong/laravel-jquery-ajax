    ...
    <div class="card">
      <div class="card-body">
        ...
        <form id="updateUser" class="form-sample" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" id="phoneUserEdit" name="phone" class="form-control" placeholder="Nhập số điện thoại"/>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="date" id="birthdayUserEdit" name="birthday" class="form-control" placeholder="dd/mm/yyyy"/>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input class="form-control" name="email" id="emailUserEdit" placeholder="Nhập email"/>
            ...
            <div class="form-group">
              ...
              <input accept="image/*" type='file' class="file-upload-default" id="imageUserEdit" name="inputFileUpdate" />
          ...
          <button type="submit" onclick=updateUser(event) class="btn btn-primary me-2">Submit</button>
