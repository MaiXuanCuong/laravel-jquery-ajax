          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" id="nameUser" name="name" class="form-control" placeholder="Nhập họ và tên"/>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" id="phoneUser" name="phone" class="form-control" placeholder="Nhập số điện thoại"/>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="date" id="birthdayUser" name="birthday" class="form-control" placeholder="dd/mm/yyyy"/>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input class="form-control" id="emailUser" name="email" placeholder="Nhập email"/>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div id="provincesUserAddError" class="form-text text-danger error-msg"></div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div id="districtsUserAddError" class="form-text text-danger error-msg"></div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div id="wardsUserAddError" class="form-text text-danger error-msg"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
              ...
              <input accept="image/*" type='file' class="file-upload-default" id="imageUser" name="inputFileAdd" />
