    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="updateSupplier" class="form-sample" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select id="genderSupplierEdit" name="gender" class="form-control">
                                        <option value="">--- Chọn giới tính --- </option>
                                        <option value="Nam">Nam</option>
                                        <option value="Nữ">Nữ</option>
                                        <option value="Khác">Khác</option>
                                    </select>
                                    <div id="genderSupplierEditError" class="form-text text-danger error-msg"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" id="birthdaySupplierEdit" name="birthday" class="form-control"
                                        placeholder="dd/mm/yyyy" />
                                    <div id="birthdaySupplierEditError" class="form-text text-danger error-msg"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="email" id="emailSupplierEdit"
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div id="provincesSupplierEditError" class="form-text text-danger error-msg"></div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div id="districtsSupplierEditError" class="form-text text-danger error-msg"></div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div id="wardSupplierEditError" class="form-text text-danger error-msg"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                <div class="form-group">
                                    ...
                                    <input accept="image/*" type='file' class="file-upload-default"
                                        id="imageSupplierEdit" name="inputFileUpdate" />
                                    <div id="imageSupplierEditError" class="form-text text-danger error-msg"></div>
                                </div>
                    ...
                    <button type="submit" onclick=updateSupplier(event) class="btn btn-primary me-2">Sửa</button>
