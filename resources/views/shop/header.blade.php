            ...
            <nav class="primary-nav primary-nav-wrapper--border">
                <div class="container">
                    ...
                    <div class="primary-nav">
                        ...
                        <a class="main-logo" href="{{ asset('shop/index.html') }}">

                            <img src="{{ asset('shop/images/logo/logo-1.png') }}" alt=""></a>
                        <!--====== End - Main Logo ======-->
                                                ...
                                                <div class="mega-menu-list">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ asset('shop/index.html') }}"><i class="fas fa-utensils u-s-m-r-6"></i>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ asset('shop/index.html') }}"><i class="fas fa-couch u-s-m-r-6"></i>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ asset('shop/index.html') }}"><i class="fas fa-football-ball u-s-m-r-6"></i>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ asset('shop/index.html') }}"><i class="fas fa-heartbeat u-s-m-r-6"></i>
                            ...
                            <div class="ah-lg-mode">
                                ...
                                <ul class="ah-list ah-list--design2 ah-list--link-color-secondary">
                                    <li>
                                        ...
                                        <a href="{{ asset('shop/shop-side-version-2.html') }}">NEW ARRIVALS</a></li>
                                    <li class="has-dropdown">
                                            ...
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <ul style="width:118px">
                                                    <li>
                                                        ...
                                                        <a href="{{ asset('shop/index.html') }}">Home 1</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/index-2.html') }}">Home 2</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/index-3.html') }}">Home 3</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <ul style="width:200px">
                                                    <li>
                                                        ...
                                                        <a href="{{ asset('shop/signin.html') }}">Signin / Already Registered</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/signup.html') }}">Signup / Register</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/lost-password.html') }}">Lost Password</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li class="has-dropdown has-dropdown--ul-left-100">

                                                <a href="{{ asset('shop/dashboard.html') }}">Dashboard<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                ...
                                                <ul style="width:200px">
                                                    <li class="has-dropdown has-dropdown--ul-left-100">
                                                        ...
                                                        <a href="{{ asset('shop/dashboard.html') }}">Manage My Account<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                        ...
                                                        <ul style="width:180px">
                                                            <li>
                                                                ...
                                                                <a href="{{ asset('shop/dash-edit-profile.html') }}">Edit Profile</a></li>
                                                            <li>

                                                                <a href="{{ asset('shop/dash-address-book.html') }}">Edit Address Book</a></li>
                                                            <li>

                                                                <a href="{{ asset('shop/dash-manage-order.html') }}">Manage Order</a></li>
                                                        </ul>
                                                        <!--====== End - Dropdown ======-->
                                                    </li>
                                                    <li>

                                                        <a href="{{ asset('shop/dash-my-profile.html') }}">My Profile</a></li>
                                                    <li class="has-dropdown has-dropdown--ul-left-100">

                                                        <a href="{{ asset('shop/dash-address-book.html') }}">Address Book<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                        ...
                                                        <ul style="width:180px">
                                                            <li>
                                                                ...
                                                                <a href="{{ asset('shop/dash-address-make-default.html') }}">Address Make Default</a></li>
                                                            <li>

                                                                <a href="{{ asset('shop/dash-address-add.html') }}">Add New Address</a></li>
                                                            <li>

                                                                <a href="{{ asset('shop/dash-address-edit.html') }}">Edit Address Book</a></li>
                                                        </ul>
                                                        <!--====== End - Dropdown ======-->
                                                    </li>
                                                    <li>

                                                        <a href="{{ asset('shop/dash-track-order.html') }}">Track Order</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/dash-my-order.html') }}">My Orders</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/dash-payment-option.html') }}">My Payment Options</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/dash-cancellation.html') }}">My Returns & Cancellations</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <ul style="width:200px">
                                                    <li>
                                                        ...
                                                        <a href="{{ asset('shop/empty-search.html') }}">Empty Search</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/empty-cart.html') }}">Empty Cart</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/empty-wishlist.html') }}">Empty Wishlist</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <ul style="width:200px">
                                                    <li>
                                                        ...
                                                        <a href="{{ asset('shop/product-detail.html') }}">Product Details</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/product-detail-variable.html') }}">Product Details Variable</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/product-detail-affiliate.html') }}">Product Details Affiliate</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <ul style="width:200px">
                                                    <li>
                                                        ...
                                                        <a href="{{ asset('shop/shop-grid-left.html') }}">Shop Grid Left Sidebar</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/shop-grid-right.html') }}">Shop Grid Right Sidebar</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/shop-grid-full.html') }}">Shop Grid Full Width</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/shop-side-version-2.html') }}">Shop Side Version 2</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li class="has-dropdown has-dropdown--ul-left-100">
                                                ...
                                                <ul style="width:200px">
                                                    <li>
                                                        ...
                                                        <a href="{{ asset('shop/shop-list-left.html') }}">Shop List Left Sidebar</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/shop-list-right.html') }}">Shop List Right Sidebar</a></li>
                                                    <li>

                                                        <a href="{{ asset('shop/shop-list-full.html') }}">Shop List Full Width</a></li>
                                                </ul>
                                                <!--====== End - Dropdown ======-->
                                            </li>
                                            <li>

                                                <a href="{{ asset('shop/cart.html') }}">Cart</a></li>
                                            <li>

                                                <a href="{{ asset('shop/wishlist.html') }}">Wishlist</a></li>
                                            <li>

                                                <a href="{{ asset('shop/checkout.html') }}">Checkout</a></li>
                                            <li>

                                                <a href="{{ asset('shop/faq.html') }}">FAQ</a></li>
                                            <li>

                                                <a href="{{ asset('shop/about.html') }}">About us</a></li>
                                            <li>

                                                <a href="{{ asset('shop/contact.html') }}">Contact</a></li>
                                            <li>

                                                <a href="{{ asset('shop/404.html') }}">404</a></li>
                                        </ul>
                                        <!--====== End - Dropdown ======-->
                                    </li>
                                    <li class="has-dropdown">
                                        ...
                                        <ul style="width:200px">
                                            <li>
                                                ...
                                                <a href="{{ asset('shop/blog-left-sidebar.html') }}">Blog Left Sidebar</a></li>
                                            <li>

                                                <a href="{{ asset('shop/blog-right-sidebar.html') }}">Blog Right Sidebar</a></li>
                                            <li>

                                                <a href="{{ asset('shop/blog-sidebar-none.html') }}">Blog Sidebar None</a></li>
                                            <li>

                                                <a href="{{ asset('shop/blog-masonry.html') }}">Blog Masonry</a></li>
                                            <li>

                                                <a href="{{ asset('shop/blog-detail.html') }}">Blog Details</a></li>
                                        </ul>
                                        <!--====== End - Dropdown ======-->
                                    </li>
                                    <li>

                                        <a href="{{ asset('shop/shop-side-version-2.html') }}">VALUE OF THE DAY</a></li>
                                    <li>

                                        <a href="{{ asset('shop/shop-side-version-2.html') }}">GIFT CARDS</a></li>
                                </ul>
                                <!--====== End - List ======-->
                            </div>
                            <!--====== End - Menu ======-->
                            ...
                            <div class="ah-lg-mode">
                                ...
                                <ul class="ah-list ah-list--design1 ah-list--link-color-secondary">
                                    <li>
                                        ...
                                        <a href="{{ asset('shop/index.html') }}"><i class="fas fa-home u-c-brand"></i></a></li>
                                    <li>
